...
const site = {
  ...
  // "/" ile ayrılan kelimeler ana sayfada daktilo efektiyle dönüşümlü yazılır
  heroLede: "Tüm etkinliklerimiz ücretsiz. / engelsiz. / sertifikalı.",
  description:
  ...
  aboutImage: `${IMG}/anasayfa-hakkimizda-resim-BGY7ZZ.webp`,
  social: {
...
// Sayfalardaki tüm sabit metinler — admin panelindeki "Metinler" sayfasından
// düzenlenir. Çok satırlı başlıklarda \n satır kırılımına dönüşür.
const texts = {
  homeHeroTitle: "ODTÜ Verimlilik\nTopluluğu",
  homeHeroButton: "Projeleri keşfet",
  homeHeroLink: "Topluluğu tanı",
  homeProjectsTitle: "Altı proje. Tek amaç.",
  homeCommitteesTitle: "Dört komite. Tek motor dairesi.",
  homeStatsTitle: "Rakamlarla\nbir öğrenci topluluğu.",
  homeStatsLede: "Öğrenciler, akademisyenler ve iş dünyası arasında 1992'den beri işleyen bir köprü.",
  homeAboutTitle: "Biz kimiz?",
  homePartnersTitle: "Partner şirketlerimiz",
  homePartnersSub: "90'dan fazla şirket iş birliğinden bazıları.",
  campusTitle: "Bizi kampüste bul.",
  campusLede: "Üyelik internet üzerinden değil, yüz yüze: Endüstri Mühendisliği Binası'ndaki Verimlilik Topluluğu Odası'na uğra ya da etkinliklerimizde tanışalım.",
  campusButton: "İletişime geç",
  campusLink: "Instagram'da takip et",
  aboutTitle: "Disiplinler arası bir köprü.\n1992'den bugüne.",
  aboutQuote: "Yarattığı farklılıklarla ulusal ve uluslararası alanda lider öğrenci topluluğu olmak.",
  aboutQuoteSource: "Topluluk vizyonu",
  aboutStatsTitle: "Otuz yılı aşkın birikim.",
  aboutStatsLede: "Kampüste bir öğrenci topluluğundan fazlası: bir okul.",
  aboutPartnersSub: "Etkinliklerin tamamı, bu iş birlikleri sayesinde katılımcılara ücretsiz.",
  projectsTitle: "Altı proje.\nSeksenden fazla etkinlik.",
  projectsLede: "Zirvelerden yarışmalara, veri biliminden sosyal sorumluluğa — hepsi ücretsiz, hepsi öğrenciler için.",
  committeesTitle: "Topluluğun motor dairesi.",
  committeesLede: "Tasarımdan sosyal medyaya, veri analizinden kampüs içi etkinliklere — topluluğun tüm işleyişini komiteler sırtlar.",
  committeesCtaTitle: "Hangi komite sana göre?",
  committeesCtaLede: "Komiteleri en iyi kampüste, etkinliklerimizde ve topluluk odamızda tanırsın.",
  teamTitle: "Topluluğu yürüten insanlar.",
  teamLede: "Yönetim Kurulu, Denetleme ve Danışma Kurulu, proje liderleri ve komite koordinatörleri; altı projeyi ve 80'den fazla etkinliği her yıl yeniden kurar.",
  teamIdariSub: "Proje liderleri ve komite koordinatörlerinden oluşur.",
  teamCtaTitle: "Bu ekibin içinde\nsenin de yerin var.",
  teamCtaLede: "Bizi kampüste bul: Endüstri Mühendisliği Binası, Verimlilik Topluluğu Odası.",
  contactTitle: "Sorun, önerin,\niş birliği fikrin mi var?",
  contactLede: "Formu doldur; ilgili ekip arkadaşımız sana dönsün.",
  kampusTitle: "Kampüste bir topluluk.",
  kampusLede: "Verimlilik Topluluğu'nu ekranda değil, ODTÜ'de tanırsın: topluluk odamız, etkinliklerimiz ve kampüsten yazılar burada.",
  kampusHours: "Ders saatleri dışında, hafta içi her gün odamız açık olur; en kalabalık saatler öğleden sonralarıdır.",
  kampusHow: "Kapıyı çal, içeri gir. Etkinliklerimizin tamamı ücretsiz ve herkese açık; tanışmak için etkinliklerimize de bekleriz.",
  kampusIntro:
    "Topluluk odası, altı projenin ve dört komitenin bir araya geldiği yerdir: bir etkinliğin afişi burada tartışılır, bir sonraki zirvenin konuşmacı listesi burada çıkar. Kampüste bize dair merak ettiğin her şeyi buradan öğrenebilirsin.",
  kampusPostsTitle: "Kampüsten yazılar",
  footerNote: "Bu etkinliklerin tamamı katılımcılara ücretsizdir; masraflar sponsorluklarla karşılanır.",
  newsletterLabel: "Etkinlik duyuruları",
  homeEventsTitle: "Yaklaşan etkinlikler"
};
...
const projects = [
  {
    ...
    team: [
      { name: "Fuat Tuna Tümer", role: "YMG'den Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/fuat-tuna-tumer-840POP.webp` },
      { name: "Cevat Miraç Aydoğan", role: "YMG Proje Lideri", photo: `${IMG}/cevat-mirac-aydogan-ZFPS8Z.webp` },
      { name: "Candan Tok", role: "YMG Proje Lideri", photo: `${IMG}/candan-tok-0N7EAA.webp` }
    ],
    hero: `${IMG}/yonetim-ve-muhendislik-gunleri-etkinlik-resmi-4BM1B5.webp`,
    gallery: [
      `${IMG}/yonetim-ve-muhendislik-gunleri-galeri-resmi-167X5B.webp`,
      `${IMG}/yonetim-ve-muhendislik-gunleri-galeri-resmi-2YQTW6.webp`,
      `${IMG}/yonetim-ve-muhendislik-gunleri-galeri-resmi-3MTDWL.webp`
    ],
    icon: "mic",
  ...
  },
  {
    ...
    team: [
      { name: "Bengisu Çonoğlu", role: "VakaVT'den Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/bengisu-conoglu-IRLU2U.webp` },
      { name: "Aybike Balcı", role: "VakaVT Proje Lideri", photo: `${IMG}/aybike-balci-M9PR4E.webp` }
    ],
    hero: `${IMG}/vakavt-etkinlik-resmi-HB27P6.webp`,
    gallery: [
      `${IMG}/vakavt-galeri-resmi-11AMH2.jpeg`,
      `${IMG}/vakavt-galeri-resmi-5MKUJ7.webp`,
      `${IMG}/vakavt-galeri-resmi-AJ17WN.webp`
    ],
    icon: "target",
    external: "",
    theme: "light",
  },
  {
    ...
    team: [
      { name: "Berk Duran", role: "W'EQUAL'dan Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/berk-duran-RDVHL4.webp` },
      { name: "Ege Turan", role: "W'EQUAL Proje Lideri", photo: `${IMG}/ege-turan-2HR8ZP.webp` },
      { name: "Esila Bulut", role: "W'EQUAL Proje Lideri", photo: `${IMG}/esila-bulut-NSLI5S.webp` }
    ],
    hero: `${IMG}/wequal-etkinlik-resmi-GH30FK.webp`,
    gallery: [
      `${IMG}/wequal-galeri-resmi-509IK2.webp`,
      `${IMG}/wequal-galeri-resmi-6PVBWI.webp`,
      `${IMG}/wequal-galeri-resmi-81TKA6.webp`
    ],
    icon: "scale",
    external: "",
    theme: "light",
  },
  {
    ...
    team: [
      { name: "İnanç Deniz Gözgözoğlu", role: "ESTIEM'den Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/inanc-deniz-gozgozoglu-UASM5F.webp` },
      { name: "Çağlan Olurluk", role: "ESTIEM Ankara METU Yerel Grup Sorumlusu", photo: `${IMG}/caglan-olurluk-5IEKZM.webp` }
    ],
    hero: `${IMG}/estiem-etkinlik-resmi-EJ0ITM.webp`,
    gallery: [
      `${IMG}/estiem-galeri-resmi-59BQCS.webp`,
      `${IMG}/estiem-galeri-resmi-7ZTX42.webp`,
      `${IMG}/estiem-galeri-resmi-LU240G.webp`
    ],
    icon: "globe",
    external: "",
    theme: "light",
  ...
  {
    slug: "ogp",
    name: "ODTÜ'lüler için Gelecek Planları",
    short: "OGP",
    ...
    team: [
      { name: "Yiğit Efe Özdemir", role: "OGP'den Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/yigit-efe-ozdemir-JTGEXS.webp` },
      { name: "Dicle Gül", role: "OGP Proje Lideri", photo: `${IMG}/dicle-gul-Q2LUBD.webp` },
      { name: "Gökay Altıntaş", role: "OGP Proje Lideri", photo: `${IMG}/gokay-altintas-DYJQWK.webp` }
    ],
    hero: `${IMG}/odtululer-icin-gelecek-planlari-etkinlik-resmi-M7OC23.webp`,
    gallery: [
      `${IMG}/odtululer-icin-gelecek-planlari-galeri-resmi-01524F.webp`,
      `${IMG}/odtululer-icin-gelecek-planlari-galeri-resmi-84S9WE.webp`,
      `${IMG}/odtululer-icin-gelecek-planlari-galeri-resmi-8QJOB8.webp`
    ],
    icon: "compass",
    external: "",
    theme: "light",
  },
  {
    ...
    team: [
      { name: "Azra Zöngür", role: "Kybele'den Sorumlu Yönetim Kurulu Üyesi", photo: `${IMG}/azra-zongur-M6QH0K.webp` },
      { name: "Derin Nesil Çelik", role: "Kybele Proje Lideri", photo: `${IMG}/derin-nesil-celik-GIOX1E.webp` }
    ],
    hero: `${IMG}/kybele-etkinlik-resmi-77FQVZ.webp`,
    gallery: [
      `${IMG}/kybele-galeri-resmi-97LDUB.webp`,
      `${IMG}/kybele-galeri-resmi-FVS9NS.webp`,
      `${IMG}/kybele-galeri-resmi-YYJRU1.webp`
    ],
    icon: "book",
    external: "",
    theme: "light",
...
const board = [
  { name: "Berk Duran", role: "Yönetim Kurulu Başkanı", photo: `${IMG}/berk-duran-RDVHL4.webp` },
  { name: "Azra Zöngür", role: "Başkan Yardımcısı", photo: `${IMG}/azra-zongur-M6QH0K.webp` },
  { name: "Yiğit Efe Özdemir", role: "Genel Sekreter", photo: `${IMG}/yigit-efe-ozdemir-JTGEXS.webp` },
  { name: "Bengisu Çonoğlu", role: "Ulusal İlişkilerden Sorumlu YK Üyesi", photo: `${IMG}/bengisu-conoglu-IRLU2U.webp` },
  { name: "İnanç Deniz Gözgözoğlu", role: "Uluslararası İlişkilerden Sorumlu YK Üyesi", photo: `${IMG}/inanc-deniz-gozgozoglu-UASM5F.webp` },
  { name: "Fuat Tuna Tümer", role: "Halkla İlişkilerden Sorumlu YK Üyesi", photo: `${IMG}/fuat-tuna-tumer-840POP.webp` },
  { name: "Demir Uluocak", role: "Mali İşlerden Sorumlu YK Üyesi", photo: `${IMG}/demir-uluocak-VZ2KRC.webp` }
];

// Denetleme ve Danışma Kurulu
const advisors = [
  { name: "Ceren Kaya", role: "Denetleme ve Danışma Kurulu", photo: `${IMG}/ceren-kaya-1U1IDC.webp` },
  { name: "Ebru Başak Arıkan", role: "Denetleme ve Danışma Kurulu", photo: `${IMG}/ebru-basak-arikan-NDCSKE.webp` },
  { name: "Mehmet Ali Konyalıoğlu", role: "Denetleme ve Danışma Kurulu", photo: `${IMG}/mehmet-ali-konyalioglu-IZU4VS.webp` }
];
...
const committees = [
  {
    ...
    icon: "pen",
    team: [
      { name: "İnanç Deniz Gözgözoğlu", role: "Dizayn Komitesinden Sorumlu YK Üyesi", photo: `${IMG}/inanc-deniz-gozgozoglu-UASM5F.webp` },
      { name: "Başbuğ Ergenekon Önder", role: "Dizayn Komitesi Koordinatörü", photo: `${IMG}/basbug-ergenekon-onder-XJXFXT.webp` },
      { name: "Sudegül Şen", role: "Dizayn Komitesi Koordinatörü", photo: `${IMG}/sudegul-sen-IH65RI.webp` },
      { name: "Roni Baran Dağ", role: "Dizayn Komitesi Koordinatörü", photo: `${IMG}/roni-baran-dag-OVA3D6.webp` }
    ]
  },
  {
    ...
    icon: "megaphone",
    team: [
      { name: "Azra Zöngür", role: "İletişim ve Pazarlamadan Sorumlu YK Üyesi", photo: `${IMG}/azra-zongur-M6QH0K.webp` },
      { name: "Alper Bozkaya", role: "İletişim ve Pazarlama Komitesi Koordinatörü", photo: `${IMG}/alper-bozkaya-2Q308X.webp` },
      { name: "Yağmur Çakırca", role: "İletişim ve Pazarlama Komitesi Koordinatörü", photo: `${IMG}/yagmur-cakirca-YWUKK1.webp` },
      { name: "Mert Kaş", role: "İletişim ve Pazarlama Komitesi Koordinatörü", photo: `${IMG}/mert-kas-003EG8.webp` }
    ]
  },
  {
    slug: "inovasyon",
    ...
    icon: "spark",
    team: [
      { name: "Yiğit Efe Özdemir", role: "İnovasyon Komitesinden Sorumlu YK Üyesi", photo: `${IMG}/yigit-efe-ozdemir-JTGEXS.webp` },
      { name: "Atahan Akharman", role: "İnovasyon Komitesi Koordinatörü", photo: `${IMG}/atahan-akharman-J9RQ58.webp` }
    ]
  },
  {
    slug: "organizasyon",
    ...
    icon: "users",
    team: [
      { name: "Demir Uluocak", role: "Organizasyon Komitesinden Sorumlu YK Üyesi", photo: `${IMG}/demir-uluocak-VZ2KRC.webp` },
      { name: "Metin Efe Şahin", role: "Organizasyon Komitesi Koordinatörü", photo: `${IMG}/metin-efe-sahin-GUZ2IX.webp` },
      { name: "Can Özbayramoğlu", role: "Organizasyon Komitesi Koordinatörü", photo: `${IMG}/can-ozbayramoglu-RRZUHQ.webp` }
    ]
  }
];

// Kampüs yazıları — /kampus sayfasındaki blog akışı.
// Buradakiler başlangıç içeriğidir; panelden düzenlenir, silinir, çoğaltılır.
const campusPosts = [
  {
    slug: "toplulugu-kampuste-nerede-bulursun",
    title: "Topluluğu kampüste nerede bulursun?",
    date: "2026-03-10",
    author: "ODTÜ VT",
    tag: "Kampüs rehberi",
    excerpt:
      "Endüstri Mühendisliği Binası'ndaki topluluk odamız, altı projenin ve dört komitenin buluştuğu yer. Kapıyı çalman yeterli.",
    body: [
      "Verimlilik Topluluğu'na internetten üye olunmaz; tanışma kampüste başlar. Odamız ODTÜ Endüstri Mühendisliği Binası'nda: koridordan geçerken kapıda topluluk tabelamızı görürsün. İçeride her saat birileri olur — bir afiş tasarlanıyordur, bir konuşmacı listesi tartışılıyordur ya da kimse bir şey yapmıyordur, çay içiliyordur.",
      "Gelmek için bir sebebe ihtiyacın yok. Hangi projenin ne yaptığını, komitelerin nasıl çalıştığını, yaklaşan etkinliklerde nasıl görev alabileceğini en hızlı buradan öğrenirsin. Sorularını odadaki herkes cevaplayabilir; kimse seni bir forma yönlendirmez.",
      "Odayı bulmakta zorlanırsan sosyal medya hesaplarımızdan yaz, biri seni kapıda karşılasın. Etkinlik dönemlerinde odanın önünde ayrıca bir stant kurulur; kampüste bize denk gelmen için en kolay zaman odur."
    ],
    cover: "",
    gallery: [],
    draft: false
  ...
  {
    slug: "etkinlige-ilk-kez-geliyorsan",
    title: "Etkinliğe ilk kez geliyorsan",
    date: "2026-02-18",
    author: "ODTÜ VT",
    tag: "Rehber",
    excerpt:
      "Kayıt, ücret, sertifika, ne giyilir, kimler katılabilir: ilk etkinliğinden önce merak edilen her şey.",
    body: [
      "Etkinliklerimizin tamamı ücretsizdir ve masraflar partner şirketlerimizin desteğiyle karşılanır. Bilet, üyelik ya da aidat gibi bir şey yok; çoğu etkinlik için tek yapman gereken duyurudaki katılım formunu doldurmak.",
      "Bölüm ya da sınıf kısıtı aramıyoruz. Yönetim ve Mühendislik Günleri gibi büyük seminerlerimize ODTÜ dışından da katılım oluyor; VakaVT'de takımlar bölüm veya okul kriteri olmadan başvurabiliyor. Katıldığın etkinliklerin çoğunda sertifika veriliyor, sertifikalar etkinlik sonrası e-posta ile gönderiliyor.",
      "Yanında bir şey getirmene gerek yok. Seminerlerde salonun kapıları etkinlik başlamadan yarım saat önce açılır; fuaye alanında partner şirketlerin standlarını gezebilir, konuşmacılarla oturum sonrasında sohbet edebilirsin. Duyuruları kaçırmamak için sayfanın altındaki bülten kutusuna e-postanı bırakabilirsin."
    ],
    cover: "",
    gallery: [],
    draft: false
...
const partners = [
  { name: "Ak Gıda / İçim", logo: `${IMG}/ak-gida-icim-MMKLNX.webp` },
  { name: "Akkim", logo: `${IMG}/akkim-A45JGP.webp` },
  { name: "Arçelik", logo: `${IMG}/arcelik-GGRD9R.webp` },
  { name: "Aygaz", logo: `${IMG}/aygaz-HIFSKC.webp` },
  { name: "Bosch", logo: `${IMG}/bosch-ST69OQ.webp` },
  { name: "Çimsa", logo: `${IMG}/cimsa-P8DWO8.webp` },
  { name: "Danone", logo: `${IMG}/danone-BYIQ9R.webp` },
  { name: "Eczacıbaşı", logo: `${IMG}/eczacibasi-W0DPNU.webp` },
  { name: "Enerjisa Üretim", logo: `${IMG}/enerjisa-uretim-AEA4NT.webp` },
  { name: "Ford Otosan", logo: `${IMG}/ford-otosan-SDALPB.webp` },
  { name: "Henkel", logo: `${IMG}/henkel-2U2T0I.webp` },
  { name: "Kale Grubu", logo: `${IMG}/kale-grubu-ELGI9G.webp` },
  { name: "L'Oréal", logo: `${IMG}/loreal-L2BCC8.webp` },
  { name: "P&G", logo: `${IMG}/pampg-8J06NZ.webp` },
  { name: "Renault MAİS", logo: `${IMG}/renault-mais-CABJVD.webp` },
  { name: "Şişecam", logo: `${IMG}/sisecam-QWW0IP.webp` },
  { name: "SOCAR", logo: `${IMG}/sokar-GNVRFE.webp` },
  { name: "Tüpraş", logo: `${IMG}/tupras-LOY6PU.webp` },
  { name: "Unilever", logo: `${IMG}/unilever-XHIAS8.webp` },
  { name: "Viatris", logo: `${IMG}/viatris-USQ8EC.webp` },
  { name: "Vodafone", logo: `${IMG}/vodafone-R53Y0J.webp` }
];

// Kanonik sıralar (sitede yan yana/alt alta görünüm sırası)
const projectOrder = ['estiem', 'kybele', 'ogp', 'vakavt', 'wequal', 'ymg'];
projects.sort((a, b) => projectOrder.indexOf(a.slug) - projectOrder.indexOf(b.slug));
const committeeOrder = ['inovasyon', 'dizayn', 'iletisim-ve-pazarlama', 'organizasyon'];
committees.sort((a, b) => committeeOrder.indexOf(a.slug) - committeeOrder.indexOf(b.slug));

module.exports = { site, texts, projects, board, advisors, committees, campusPosts, partners };
