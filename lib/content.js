...
const projects = [
  ...
  },
  {
    ...
    name: "Generation",
    short: "Generation",
    tagline: "Kampüsün ilk kapsamlı yapay zekâ ve veri bilimi projesi.",
    summary:
      "DataDays, MetaChats ve uygulamalı eğitimlerle yükselen teknoloji alanlarında yetenekleri sektörün öncü firmalarıyla buluşturur.",
    body: [
      "Generation, ODTÜ kampüsünün ilk kapsamlı yapay zekâ ve veri bilimi projesidir. Projemiz kapsamındaki DataDays, MetaChats ve çeşitli workshop & eğitimlerle yükselen teknoloji alanlarında yetenekli bireylerle sektörün öncü firmalarını bir araya getirerek katılımcılara uygulamalı deneyim, uzman bakış açıları ve kariyer fırsatları sunmayı hedefler.",
      "DataDays; SQL testi, CV ve GitHub değerlendirmeleri ile seçilen katılımcıların yer aldığı, iki gün süren, datathon ve çeşitli workshop etkinlikleriyle zenginleştirilmiş bir organizasyondur. Yalnızca datathonlardan oluşan bir yarışma değil; staj deneyimi kazandıran, sektörün önde gelen veri bilimcileriyle tanışma ve değerli ödüller kazanma fırsatı sunan bir platformdur.",
      "MetaChats, yapay zekâ ve veri bilimi alanında öncü isimlerle geniş kitlelere hitap eden söyleşilerdir; genel katılıma açıktır. Workshop & eğitimler ise veri bilimi, yapay zekâ ve teknoloji alanlarında başlangıç seviyesindeki ya da kendini geliştirmek isteyen katılımcılara uygulamalı eğitimler sunar."
    ],
    facts: [
      { label: "Etkinlikler", value: "DataDays, MetaChats, workshoplar" },
      { label: "Odak", value: "Yapay zekâ, veri bilimi" },
      { label: "DataDays seçimi", value: "SQL testi, CV, GitHub" }
    ],
    team: [],
    hero: `${IMG}/generation-etkinlik-resmi-0LGMJD.jpg`,
    gallery: [
      `${IMG}/generation-galeri-resmi-3PB35W.jpeg`,
      `${IMG}/generation-galeri-resmi-4VX7QA.jpeg`,
      `${IMG}/generation-galeri-resmi-DXLWW5.jpeg`
    ],
    icon: "chip",
    external: "https://www.odtuvt.org.tr/proje-generation",
    theme: "light",
    featured: true
  },
  {
  ...
  },
  {
    ...
    name: "Çözüm Sende!",
    short: "Çözüm Sende!",
    tagline: "Sorunun değil, çözümün bir parçası.",
    summary:
      "Köy okulu ve barınak ziyaretleri, farkındalık ve işaret dili eğitimleriyle topluma ve doğaya dokunan sosyal sorumluluk projesi.",
    body: [
      "Çözüm Sende!, ODTÜ Verimlilik Topluluğu'nun sosyal sorumluluk ve farkındalık sahibi bir topluluk olduğunun göstergesi olarak öncü bir şekilde ortaya çıkmış projesidir. Köklü ve öncü bir topluluk olmanın verdiği sorumluluk bilinci ile “Sorunun Değil, Çözümün Bir Parçası” olmak için çalışıyoruz. Bu süreci birçok vakıf ve sivil toplum kuruluşu ile yürütüyoruz.",
      "Temel amacımız toplumdaki ve yaşadığımız doğayla ilgili sorunlara çözüm sağlamak ve bunu yapacak bireylere farkındalık kazandırmaktır. Bu amaçla köy okulu ziyaretleri, barınak ziyaretleri, farkındalık ve işaret dili eğitimleri, alanında yetkin kişilerle söyleşiler düzenliyoruz.",
      "Ayrıca topluluğumuzun tüm etkinliklerinin engelsiz düzenlenmesini ve herkese ulaşmasını sağlıyoruz."
    ],
    facts: [
      { label: "Alan", value: "Sosyal sorumluluk" },
      { label: "Etkinlikler", value: "Köy okulu ve barınak ziyaretleri, eğitimler" },
      { label: "İş birliği", value: "Vakıflar ve sivil toplum kuruluşları" }
    ],
    team: [],
    hero: `${IMG}/cozum-sende-etkinlik-resmi-IUU2W5.jpg`,
    gallery: [
      `${IMG}/cozum-sende-galeri-resmi-19NYUF.jpeg`,
      `${IMG}/cozum-sende-galeri-resmi-32H85T.jpeg`,
      `${IMG}/cozum-sende-galeri-resmi-4TOZDI.jpeg`
    ],
    icon: "leaf",
    external: "https://www.odtuvt.org.tr/proje-cozum-sende",
    theme: "light",
    featured: false
  },
  {
...
const committees = [
  {
    ...
    body: [
      "Dizayn Komitesi, topluluğumuzun ve projelerimizin tanıtımı için yararlandığımız görsel ve basılı materyallerin tasarımından sorumludur. Dizayn Komitesi koordinatörleri, görev dağılımıyla birlikte 8 farklı projeyi ve topluluğu en iyi şekilde tanıtabilmek için büyük bir özveriyle çalışır.",
